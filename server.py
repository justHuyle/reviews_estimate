...
MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ecommerce_preference_model.pkl")
...
def predict():
    try:
        ...
        # Pipeline đã bao gồm TF-IDF vectorizer → Logistic Regression
